...
export function saveScoreB() {
  var levelScore = 0;
  if (brickVar.currLevel === "classic") levelScore = 0;
  if (brickVar.currLevel === "castle") levelScore = 104;
  else if (brickVar.currLevel === "x") levelScore = 104 + 169;
  else if (brickVar.currLevel === "invader") levelScore = 104 + 169 + 169;
